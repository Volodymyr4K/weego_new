      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 border-t border-weego-gray pt-12">
            ...
            <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
                <span className="font-mono text-xs text-gray-500 uppercase tracking-widest mb-2">[CONTACT]</span>
                <a href="mailto:munister@outlook.com" className="font-display text-2xl uppercase hover:text-weego-lime transition-colors break-all">munister@outlook.com</a>
                <p className="font-sans text-gray-400">Lviv, Ukraine <br/> Remote Worldwide</p>
            </div>

            {/* Column 2: Socials */}
            <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
                <span className="font-mono text-xs text-gray-500 uppercase tracking-widest mb-2">[SOCIAL]</span>
            ...
            {/* Column 3: Legal */}
            <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
                <span className="font-mono text-xs text-gray-500 uppercase tracking-widest mb-2">[LEGAL]</span>
             ...
             <div className="flex flex-col justify-between h-full items-center md:items-start text-center md:text-left">
                <span className="font-mono text-xs text-gray-500 uppercase tracking-widest mb-2">[SYSTEM]</span>
                <div>
