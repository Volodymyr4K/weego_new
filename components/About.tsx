      ...
      <div className="px-6 max-w-[1800px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32">
            ...
            <div className="grid grid-cols-2 gap-8 relative">
                 ...
                 <div className="absolute -top-4 -left-4 w-4 h-4 border-t border-l border-black" />
                 <div className="absolute -bottom-4 -right-4 w-4 h-4 border-b border-r border-black" />
            ...
            <div className="bg-weego-black text-weego-white p-8 md:p-12 relative overflow-hidden group">
                ...
                <h3 className="font-mono text-weego-lime uppercase tracking-widest mb-8 border-b border-gray-800 pb-4 inline-block">
                    // Manifesto v1.0
                </h3>
